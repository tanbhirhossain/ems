...
@section('page_title', 'Edit News | EMS')
@section('style')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('admin-news.update', $show_news->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                              <input type="text" name="news_title" class="form-control" value="{{$show_news->news_title}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                              <textarea class="form-control" name="news_details" required>{{$show_news->news_details}}</textarea> 
                              <script>
            ...
            <img height="200" width="400" class="img-responsive" src="{{asset($show_news->fetured_image)}}">
						  <div class="image-upload-wrap col-md-12">
						    ...
						    <div class="drag-text">
						      <h3>Drag and drop or select to <strong>CHANGE</strong> FEATURED IMAGE</h3>
						    </div>
						  </div>
						  <div class="file-upload-content">
						    <img class="file-upload-image" src="{{asset($show_news->fetured_image)}}" alt="your image" />
						...
						<div class="col-md-10">
						<div class="col-md-6">
              <img height="200" width="400" class="img-responsive" src="{{asset($show_news->others_1)}}">
								<input class="form-control" type="file" name="others_1">
							</div>
							<div class="col-md-6">
                <img height="200" width="400" class="img-responsive" src="{{asset($show_news->others_2)}}">
								<input class="form-control" type="file" name="others_2">
							</div>
							<div class="col-md-6">
                <img height="200" width="400" class="img-responsive" src="{{asset($show_news->others_3)}}">
								<input class="form-control" type="file" name="others_3">
							</div>
							<div class="col-md-6">
                <img height="200" width="400" class="img-responsive" src="{{asset($show_news->others_4)}}">
								<input class="form-control" type="file" name="others_4">
							</div>
              <div class="col-md-6">
                <img height="200" width="400" class="img-responsive" src="{{asset($show_news->others_5)}}">
                <input class="form-control" type="file" name="others_5">
              </div>
              <div class="col-md-6">
                <img height="200" width="400" class="img-responsive" src="{{asset($show_news->others_6)}}">
